      ...
      <nav className="fixed top-24 sm:top-12 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-7xl flex items-center justify-between px-4 py-2 transition-all duration-300">
        ...
        <div
          className={`flex items-center justify-center rounded-full transition-all duration-300
            ...
            ${"md:static absolute left-1/2 -translate-x-1/2 md:translate-x-0"}`} // center on mobile
        >
          <Image
            src="/img/logo.png"
            width={100}
        ...
        <div className="hidden md:flex items-center gap-8 text-lg text-white/90">
          <Link href={createPageUrl("Services")} className="hover:text-amber-400">Services</Link>
          <a href="#events" className="hover:text-amber-400">Events</a>
          <a href="#equipment" className="hover:text-amber-400">Equipment</a>
